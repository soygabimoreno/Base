...
sealed interface PlaylistDetailAction {
    ...
    data class OnAudioItemClicked(val playlistAudioItem: PlaylistAudioItem) : PlaylistDetailAction
    data class OnAudioItemsReordered(val playlistAudioItems: List<PlaylistAudioItem>) :
        PlaylistDetailAction
    data class OnRemovePlaylistAudioItem(val playlistAudioItemId: String) : PlaylistDetailAction
    ...
    data class OnDialogTitleChange(val title: String) : PlaylistDetailAction
    data class OnDialogDescriptionChange(val description: String) : PlaylistDetailAction
