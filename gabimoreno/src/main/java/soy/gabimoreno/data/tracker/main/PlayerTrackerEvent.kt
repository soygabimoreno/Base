...
sealed class PlayerTrackerEvent(
    ...
    data class ClickPlay(override val parameters: Map<String, Any>) : PlayerTrackerEvent()
    data class ClickPause(override val parameters: Map<String, Any>) : PlayerTrackerEvent()
}
