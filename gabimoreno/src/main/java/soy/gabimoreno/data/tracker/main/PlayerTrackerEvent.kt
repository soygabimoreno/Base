...
sealed class PlayerTrackerEvent(
    ...
    data class ClickSkipToPrevious(override val parameters: Map<String, Any>) : PlayerTrackerEvent()
    data class ClickSkipToNext(override val parameters: Map<String, Any>) : PlayerTrackerEvent()
