...
fun CloudPlaylistItemResponse.toPlaylistItemDbModel() =
...
fun PlaylistItemsDbModel.toCloudPlaylistItemResponse() =
...
fun PlaylistAudioItem.toCloudPlaylistItemResponse(playlistId: Int) =
    CloudPlaylistItemResponse(
